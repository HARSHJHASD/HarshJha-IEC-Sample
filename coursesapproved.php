...
<head>
  ...
  <!-- seo title -->
  <meta name="title"
    content="Engineering College in Noida | MBA College in Noida | Pharmacy College in Greater Noida Engineering College in Greater Noida">
  <!-- seo description -->
...
The institute is affiliated to Uttar Pradesh Technical University Formerly Mahamaya">
  <!-- seo keywords -->
  <meta name="keywords"
  ...
  <link rel="stylesheet" href="assets\css\coursesapproved.css">
  <!-- Google Fonts -->
...
<body>
    ...
    <div class="container">
      ...
      <div class="about-us-main-div">
        <div class="article-content">
          <center>
            <h3>
              IEC Group of Institutions Approved Courses
            </h3>
          </center>

          <div class="table-div">

            <img src="https://www.iec.edu.in/img/appro.jpg" class="pic img-responsive" alt="b pharm degree">
              ...
              <table class="table">
                ...
                <tbody>
                  ...
                  <tr>
                    ...
                    <td>ELECTRONICS &amp; COMMUNICATION ENGG (ECE)</td>
                    <td style="text-align: center;">4</td>
                  ...
                  <!--<tr>
  <td width="59">7</td>
  <td width="79">PHARMACY(M.PHARM)</td>
  <td width="84">POST GRADUATE</td>
  <td width="120">PHARMACY</td>
  <td width="101">PHARMACEUTICS</td>
  ...
  <td>BHMCT</td>
  <td>UNDER GRADUATE</td>
  <td>HOTEL MANAGEMENT AND CATERING TECHNOLOGY</td>
  <td>HOTEL MANAGEMENT AND CATERING TECHNOLOGY (BHMCT)</td>
  <td style="text-align: center;">4</td>
  ...
  <tr>
  <td>19</td>
  <td>Integrated Master of Business Administration (BBA+MBA) </td>
  <td>DUAL DEGREE PROGRAMS</td>
  <td>MANAGEMENT</td>
  <td>MASTERS IN BUSINESS ADMINISTRATION (Integrated MBA)</td>
  <td style="text-align: center;">5</td>
          ...
          <div class="btan" style="text-align:center">
            <a href="https://www.iec.edu.in/admissions/online" class="btn btn-success">Apply Now</a>
          </div>
        </div>
      </div>
    </div>
